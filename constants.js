...
export const allNavLinks = {
    ...
    behavior: { href: 'behavior', text: 'Behavior Log', icon: `<svg class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`},
    lunch: { href: 'lunch', text: 'Lunch Menu', icon: `<svg class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 12a5 5 0 01-5 5H4a1 1 0 01-1-1v-4a1 1 0 011-1h1a5 5 0 015-5m0 0a5 5 0 005 5h1a1 1 0 011 1v4a1 1 0 01-1 1h-1a5 5 0 00-5-5z" /></svg>`},
...
export const rolesConfig = {
    admin: ['myday', 'launchpad', 'users', 'courses', 'homework', 'attendance', 'gradebook', 'behavior', 'lunch', 'reportCards', 'calendar', 'reports', 'tuition', 'profile', 'settings'],
    teacher: ['myday', 'launchpad', 'courses', 'homework', 'attendance', 'gradebook', 'behavior', 'reportCards', 'calendar', 'profile'],
    student: ['myday', 'launchpad', 'courses', 'homework', 'gradebook', 'lunch', 'reportCards', 'calendar', 'tuition', 'profile'],
    parent: ['parentDashboard', 'launchpad', 'homework', 'gradebook', 'behavior', 'lunch', 'reportCards', 'calendar', 'tuition', 'reports', 'profile'],
};
